...
CREATE TABLE IF NOT EXISTS treasury_executions (
    ...
    execution_state VARCHAR(30) NOT NULL DEFAULT 'PENDING', -- PENDING, QUEUED, VALIDATING, EXECUTING, COMPLETED, FAILED, CANCELLED, EXPIRED
    tx_hash VARCHAR(66),
    block_number BIGINT,
    gas_used BIGINT,
